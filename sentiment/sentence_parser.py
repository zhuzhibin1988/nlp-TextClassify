...
class LtpParser:
    def __init__(self):
        ...
        self.parser = Parser()
        self.parser.load(os.path.join(LTP_MODEL_DIR, "parser.model"))

        self.recognizer = NamedEntityRecognizer()
        self.recognizer.load(os.path.join(LTP_MODEL_DIR, "ner.model"))

        self.labeller = SementicRoleLabeller()
        self.labeller.load(os.path.join(LTP_MODEL_DIR, 'pisrl.model'))
